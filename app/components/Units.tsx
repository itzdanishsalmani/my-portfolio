    ...
    return (
        <div>
            <a href={liveLink} target="_blank" rel="noopener noreferrer">
                <div className="group hover:bg-slate-800 p-4 cursor-pointer rounded-lg flex flex-col justify-center items-center md:flex-row md:items-start">
